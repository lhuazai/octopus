...
module.exports = function (sSource) {
  ...
  let aDesktopClassName = _.uniq(
    sPugString.match(
      /\.(m|ml|mr|mt|mb|mx|my)-[0-9]+|\.(mi|mli|mri|mti|mbi|mxi|myi)-[0-9]+|\.(p|pl|pr|pt|pb|px|py)-[0-9]+|\.(pi|pli|pri|pti|pbi|pxi|pyi)-[0-9]+|\.(w|wp)-[0-9]+|\.(h|hp)-[0-9]+|\.(l|r|t|b)-[0-9]+|\.lh-[0-9]+|\.(fs|fw)-[0-9]+|\.br-[0-9]+|\.(bgs|rounded)-[0-9]+/g
    )
  );
